...
说明是否使用 VS Code workspace，以及是否发现固定路径配置。
...
## Skill Reference
说明本次如何参考 `ai-skill-hub` 中的 `project-takeover` skill。

需要说明：
- skill-hub 是参考仓库，不是本项目代码；
- project-takeover 的用途；
- 本次采用了哪些接手思路；
- 哪些内容只是判断，不应直接修改代码。
...
- 仅允许新建本文件 tasks/intern_project_takeover_20260609.md
